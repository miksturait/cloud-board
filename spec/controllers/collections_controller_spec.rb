  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved collection as @collection" do
        ...
        post :create, {:collection => { "title" => "invalid value" }}, valid_session
        expect(assigns(:collection)).to be_a_new(Collection)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested collection" do
        ...
        expect_any_instance_of(Collection).to receive(:update).with({ "title" => "MyString" })
        put :update, {:id => collection.to_param, :collection => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the collection as @collection" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Collection).to receive(:save).and_return(false)
        put :update, {:id => collection.to_param, :collection => { "title" => "invalid value" }}, valid_session
        expect(assigns(:collection)).to eq(collection)
      end
